...
# Update this path to match the actual path on your Windows machine
WIN_DB_PATH = Path(r"C:\ProgramData\Cold Turkey\data-app.db")

logging.basicConfig(level=logging.INFO, format="%(levelname)s -> %(message)s")

def blocker_summary(blocks: dict[str, Any]) -> None:
    """Shows a summary of all blockers present in the app in terminal."""
...
def main():
    ...
    try:
        ...
        os.system("taskkill /F /IM 'ColdTurkey.exe'")  # Terminate the Cold Turkey Blocker process
